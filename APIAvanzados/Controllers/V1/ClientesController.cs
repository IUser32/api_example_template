...
public class ClientesController : ControllerBase
{
    ...
    [HttpGet("paginado")]
    public async Task<ActionResult<RespuestaPaginada<Cliente>>> ObtenerPaginado([FromQuery] ParametrosPaginacion parametros)
    {
    ...
    public async Task<ActionResult<Cliente>> Crear(Cliente cliente)
    {
        ...
        return CreatedAtAction(nameof(ObtenerPorId), new { id = cliente.Id, version = "1.0" }, cliente);
    }
