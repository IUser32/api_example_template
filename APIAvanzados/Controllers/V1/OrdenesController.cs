...
public class OrdenesController : ControllerBase
{
    ...
    [HttpGet("paginado")]
    public async Task<ActionResult<RespuestaPaginada<Orden>>> ObtenerPaginado([FromQuery] ParametrosPaginacion parametros)
    {
    ...
    public async Task<ActionResult<Orden>> Crear(Orden orden)
    {
        ...
        return CreatedAtAction(nameof(ObtenerPorId), new { id = orden.Id, version = "1.0" }, orden);
    }
